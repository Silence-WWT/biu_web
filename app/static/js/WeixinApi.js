...
var WeixinApi = (function () {
    ...
    function weixinShareTimeline(data, callbacks) {
        ...
        WeixinJSBridge.on('menu:main:timeline', function (argv) {
    ...
    function weixinSendAppMessage(data, callbacks) {
        ...
        WeixinJSBridge.on('menu:main:appmessage', function (argv) {
            if (callbacks.async && callbacks.ready) {
                window["_wx_loadedCb_"] = callbacks.dataLoaded || new Function();
                if(window["_wx_loadedCb_"].toString().indexOf("_wx_loadedCb_") > 0) {
                    window["_wx_loadedCb_"] = new Function();
    ...
    function weixinShareWeibo(data, callbacks) {
        ...
        WeixinJSBridge.on('menu:main:weibo', function (argv) {
            if (callbacks.async && callbacks.ready) {
                window["_wx_loadedCb_"] = callbacks.dataLoaded || new Function();
                if(window["_wx_loadedCb_"].toString().indexOf("_wx_loadedCb_") > 0) {
                    window["_wx_loadedCb_"] = new Function();
    ...
    function weixinGeneralShare(data, callbacks) {
        ...
        WeixinJSBridge.on('menu:general:main', function (general) {
            if (callbacks.async && callbacks.ready) {
                window["_wx_loadedCb_"] = callbacks.dataLoaded || new Function();
                if(window["_wx_loadedCb_"].toString().indexOf("_wx_loadedCb_") > 0) {
                    window["_wx_loadedCb_"] = new Function();
